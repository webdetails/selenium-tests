...
public class SelectCdaFileAsDatasource {
  ...
  public void tc1_SelectCdaFileAsDatasource_PathOfCdaFileCorrect() throws Exception {
    ...
    driver = WidgetUtils.CreateWidget(driver, widgetName);
    ...
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//table[@id='table-cdfdd-datasources-properties']/tbody/tr[4]/td[2]/button"));
    driver.findElement(By.xpath("//table[@id='table-cdfdd-datasources-properties']/tbody/tr[4]/td[2]/button")).click();
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.id("popupbox")));
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.id("popup_state_browse")));
    //Click in 'Public'
    ...
    wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("container_id")));
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.xpath("//a[@rel='public/plugin-samples/']")));
    driver.findElement(By.xpath("//a[@rel='public/plugin-samples/']")).click();;
    //Click in 'cda'
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.xpath("//a[@rel='public/plugin-samples/cda/']")));
    driver.findElement(By.xpath("//a[@rel='public/plugin-samples/cda/']")).click();
    //Click in 'cdafiles'
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.xpath("//a[@rel='public/plugin-samples/cda/cdafiles/']")));
    driver.findElement(By.xpath("//a[@rel='public/plugin-samples/cda/cdafiles/']")).click();
    //Select a file
    assertNotNull(ElementHelper.WaitForElementVisibility(driver, By.xpath("//a[@rel='public/plugin-samples/cda/cdafiles/compoundJoin.cda']")));
    ...
    ElementHelper.WaitForElementInvisibility(driver, By.id("popup_browse_buttonOk"));
    //SAVE the widget
    ...
    ElementHelper.WaitForElementInvisibility(driver, By.id("notifyBar"));
