...
public class AddParamTableComponent {
  ...
  public void testCheckParametersAddingWidgetParameter() throws Exception {
    ...
    //Click in parameters
    ElementHelper.WaitForElementVisibility(driver, By.id("table-cdfdd-components-properties"));
    ...
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//div[@id='popupbox']/div[2]"));
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//div[@id='popupbox']/div[2]/div/div[2]/div/div/div/input[@class='StringListAddButton']"));
    Thread.sleep(100);
    ...
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//div[@id='popupbox']/div[2]/div/div[2]/div/div/div/div/div/div"));
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//div[@id='popupbox']/div[2]/div/div[2]/div/div/div/div/div/div[2]"));
    ...
    // Add the Arg
    ElementHelper.WaitForElementVisibility(driver, By.id("arg_0"));
    ElementHelper.WaitForElementVisibility(driver, By.id("val_0"));
    ElementHelper.WaitForElementVisibility(driver, By.id("popup_state0_buttonOk"));
    ...
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//table[@id='table-cdfdd-components-properties']/tbody/tr[3]/td[2]"));
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//div[@id='headerLinks']/div[2]/a"));
    ...
    ElementHelper.WaitForElementVisibility(driver, By.xpath("//table[@id='table-cdfdd-components-components']/tbody/tr[3]/td/span"));
