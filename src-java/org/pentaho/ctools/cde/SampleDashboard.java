...
public class SampleDashboard {
  ...
  public void tc4_UpdateTableByClickingChart_TableUpdatedForSpecificData() {
     ...
     * ## Step 1
     */
    String sampleChartTitle = this.elemHelper.WaitForElementPresentGetText( this.driver, By.xpath( "//div[contains(@id,'chart')]/div/*[local-name()='svg' and namespace-uri()='http://www.w3.org/2000/svg']/*[local-name()='g']/*[local-name()='g']/*[local-name()='g']/*[local-name()='g']/*[local-name()='text']" ) );
