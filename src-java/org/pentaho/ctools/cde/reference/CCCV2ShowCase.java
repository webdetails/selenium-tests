...
public class CCCV2ShowCase {
  ...
  public void tc03_ChartContent_DisplayedCorrect() {
    ...
    acts3.perform();
    String pieSeriesLabel = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[2]/td[1]/span"));
    acts3.perform();
    String pieSeriesValue = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[2]/td[3]/span"));
    acts3.perform();
    String pieTimeLabel = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[1]/td[1]/span"));
    acts3.perform();
    String pieTimeValue = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[1]/td[3]/span"));
    acts3.perform();
    String pieValueLabel = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[3]/td[1]/span"));
    acts3.perform();
    String pieValueValue = ElementHelper.WaitForElementPresentGetText(driver, By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[3]/td[3]/span"));
