...
public class CCCV2ShowCase {
  ...
  public void tc03_ChartContent_DisplayedCorrect() {
    ...
    acts3.perform();
    String pieSeriesLabel = driver.findElement(By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[2]/td[1]/span")).getText();
    acts3.perform();
    String pieSeriesValue = driver.findElement(By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[2]/td[3]/span")).getText();
    acts3.perform();
    String pieTimeLabel = driver.findElement(By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[1]/td[1]/span")).getText();
    acts3.perform();
    String pieTimeValue = driver.findElement( By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[1]/td[3]/span")).getText();
    acts3.perform();
    String pieValueLabel = driver.findElement(By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[3]/td[1]/span")).getText();
    acts3.perform();
    String pieValueValue = driver.findElement(By.xpath("//div[@class='tipsy tipsy-se']/div[2]/div/table/tbody/tr[3]/td[3]/span")).getText();
