...
public class SampleDashboard {
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    this.driver.get( PageUrl.SAMPLE_DASHBOARD_REQUIRE );
  ...
  public void tc4_UpdateTableByClickingChart_TableUpdatedForSpecificData() {
     ...
     * ## Step 2
     */
    this.elemHelper.MouseOverElementAndClick( this.driver, By.xpath( "//div[contains(@id,'chart')]/div/*[local-name()='svg' and namespace-uri()='http://www.w3.org/2000/svg']/*[local-name()='g']/*[local-name()='g'][3]/*[local-name()='g']/*[local-name()='g'][2]//..//*[local-name()='rect'][2]" ) );
