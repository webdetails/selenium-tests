...
public class OlapSelectorComponent {
  ...
  public void tc01_OlapSelectorComponent_SniffTestSample() {
    ...
    DRIVER.get( BASE_URL + "api/repos/%3Apublic%3Aplugin-samples%3Apentaho-cdf-dd%3Apentaho-cdf-dd-require%3Atests%3AOlapSelector%3AolapSelector.wcdf/generatedContent" );
