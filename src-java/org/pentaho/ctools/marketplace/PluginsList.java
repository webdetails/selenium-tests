...
public class PluginsList {
  ...
  private static Logger     LOG                = LogManager.getLogger( PluginsList.class );
  ...
  public void setUp() throws Exception {
    LOG.info( "setUp##" + PluginsList.class.getSimpleName() );
  ...
  public void tearDown() {
    LOG.info( "tearDown##" + PluginsList.class.getSimpleName() );
  }
}
