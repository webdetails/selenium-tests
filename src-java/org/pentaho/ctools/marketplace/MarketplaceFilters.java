...
public class MarketplaceFilters {
  ...
  private static Logger     LOG                = LogManager.getLogger( MarketplaceFilters.class );
  ...
  public void setUp() throws Exception {
    LOG.info( "setUp##" + MarketplaceFilters.class.getSimpleName() );
   ...
   *    2. Input 'Community' on search field, check Customer stages 1 and 3  and uncheck "Analysis" and "Data" on Type and assert shown plugins
  ...
  public void tearDown() {
    LOG.info( "tearDown##" + MarketplaceFilters.class.getSimpleName() );
  }
}
