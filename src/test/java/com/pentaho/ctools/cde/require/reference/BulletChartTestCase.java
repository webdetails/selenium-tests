 ...
 *
 ******************************************************************************/
package com.pentaho.ctools.cde.require.reference;
...
public class BulletChartTestCase extends BaseTest {
  ...
  public void tc00_OpenSamplePage_Display() {
    ...
    this.elemHelper.Get( BaseTest.driver, PageUrl.BULLET_CHART_TEST_CASE_REQUIRE );
  ...
  public void tc01_ChartContent_DisplayedCorrect() {
    ...
    Assert.assertEquals( "Bullet chart test case", title );
    ...
    acts.moveToElement( this.elemHelper.FindElement( BaseTest.driver, By.cssSelector( "div.webdetailsFooterCtools" ) ) );
    acts.perform();
    //Chart 4
    //Check title
