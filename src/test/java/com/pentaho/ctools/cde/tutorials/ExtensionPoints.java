...
public class ExtensionPoints extends BaseTest {
  ...
  public void tc3_TextLinks_Displayed() {
    ...
    //Step #1
    CdeTutorials.clickAndCheckPageLoaded( By.xpath( "//p/a[contains(text(),'Protovis')]" ), By.xpath( "//title" ), "Protovis" );
    //Step #2
    CdeTutorials.clickAndCheckPageLoaded( By.xpath( "//p/a[contains(text(),'CCC')]" ), By.xpath( "//h1[contains(text(),'CCC')]" ), "CCC" );
    //Step #3
    CdeTutorials.clickAndCheckPageLoaded( By.xpath( "//a[contains(text(),'radians')]" ), By.xpath( "//title" ), "Radian - Wikipedia, the free encyclopedia" );

    for ( WebElement link : links ) {
      CdeTutorials.clickAndCheckPageLoaded( link, By.xpath( "//title" ), "Protovis - Labels" );
    }
