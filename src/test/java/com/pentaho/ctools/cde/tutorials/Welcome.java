...
public class Welcome extends BaseTest{
	  ...
	  public void tc2_TextLinks_Displayed()
	  {
		  ...
		  CdeTutorials.clickAndCheckPageLoaded(	By.xpath("//p/a[contains(text(),'CDE')]"),
				  								By.xpath("//h1[contains(text(),'CDE')]"),
				  								"CDE");
		  
		  //Step #2 - Check CDA link
		  CdeTutorials.clickAndCheckPageLoaded(	By.xpath("//p/a[contains(text(),'CDA')]"),
		  ...
		  CdeTutorials.clickAndCheckPageLoaded(	By.xpath("//p/a[contains(text(),'CDF')]"),
						  						By.xpath("//h1[contains(text(),'CDF')]"),
												"CDF");
		  
		  //Step #5 - Check C-Tools Forum link
		  CdeTutorials.clickAndCheckPageLoaded(	By.xpath("//a[contains(text(),'CTools Forum')]"),
												By.xpath("//*[@id='pagetitle']/h1/span"),
