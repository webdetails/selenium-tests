...
/**
 * Testing the functionalities related with CDE Tutorials - CCC: Enhancing Charts.
 *
...
public class EnhancingCharts extends BaseTest {
	   ...
	   *
	   * Test Case Name:
	   *    Enhancing Charts Page Sections
	   *    
	   * Test Case Description:
	   * 	Check sections in Enhancing Charts page.
	   * 
	   * Test Steps:
	   * 		1. Check if headings are present and correctly displayed;
	   */
	  @Test
	  public void tc0_EnhancingChartsSections_Displayed()
	  {
		  this.log.info( "tc0_EnhancingChartsSections_Displayed" );
