 ...
 *
 ******************************************************************************/
package com.pentaho.ctools.cde.samples.legacy.realtime;
...
public class RealTimeSampleDashboard extends BaseTest {
  ...
  public void tc00_OpenSamplePage_Display() {
    ...
    this.elemHelper.Get( BaseTest.driver, PageUrl.REAL_TIMTE_DASHBOARD_LEGACY );
   ...
   * 
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.legacy.realtime.RealTimeSampleDashboard.tc00_OpenSamplePage_Display" )
  ...
  public void tc02_ChartRender_Display() {
     ...
     */
    String crtLat = this.elemHelper.WaitForElementPresentGetText( driver, By.cssSelector( "#graphicColumnprotovis > svg > g > g:nth-child(1) > g > g > g > g > g:nth-child(1) > g:nth-child(2) > text" ) );
    Assert.assertEquals( crtLat, "Lat.G" );
    String crtLong = this.elemHelper.WaitForElementPresentGetText( driver, By.cssSelector( "#graphicColumnprotovis > svg > g > g:nth-child(1) > g > g > g > g > g:nth-child(2) > g:nth-child(2) > text" ) );
   ...
   * 
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.legacy.realtime.RealTimeSampleDashboard.tc02_ChartRender_Display" )
