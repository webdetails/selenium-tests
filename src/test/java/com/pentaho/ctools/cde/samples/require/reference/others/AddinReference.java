...
public class AddinReference extends BaseTest {
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc00_OpenSamplePage_Display" )
  public void tc01_PageContent_ContentDisplayed() {
     ...
     */
    //Check title
    String expectedTitle = "AddIn Reference";
    String actualTitle = this.elemHelper.WaitForTitle( driver, expectedTitle );
    assertEquals( actualTitle, expectedTitle );

    // Check subtitle
    String expectedTextSubTitle1 = "AddIns reference";
    String actualTextSubTitle1 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='Title']/span" ) );
    assertEquals( actualTextSubTitle1, expectedTextSubTitle1 );

    // Check subtitle
    String expectedTextSubTitle2 = "AddIn Implementation";
    String actualTextSubTitle2 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='DescriptionBody']/div" ) );
    assertEquals( actualTextSubTitle2, expectedTextSubTitle2 );

    // Check subtitle
    String expectedTextSubTitle3 = "Setting options";
    String actualTextSubTitle3 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='DescriptionBody']/div[2]" ) );
    assertEquals( actualTextSubTitle3, expectedTextSubTitle3 );

    // Check subtitle
    String expectedTextSubTitle4 = "Setting defaults";
    String actualTextSubTitle4 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='DescriptionBody']/div[3]" ) );
    assertEquals( actualTextSubTitle4, expectedTextSubTitle4 );

    // Check subtitle
    String expectedTextSubTitle5 = "Implementation arguments";
    String actualTextSubTitle5 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='DescriptionBody']/div[4]" ) );
    assertEquals( actualTextSubTitle5, expectedTextSubTitle5 );

    // Check subtitle
    String expectedTextSubTitle6 = "Calling AddIns from components";
    String actualTextSubTitle6 = this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//div[@id='DescriptionBody']/div[5]" ) );
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc01_PageContent_ContentDisplayed" )
  public void tc02_Sparkline_SampleWorks() {
    ...
    //Check the hyperlink
    this.elemHelper.WaitForAttributeValueEqualsTo( driver, By.cssSelector( "#SparklineDescHtml > a" ), "href", "http://www.omnipotent.net/jquery.sparkline/" );
    String attrHref = this.elemHelper.GetAttribute( driver, By.cssSelector( "#SparklineDescHtml > a" ), "href" );
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc02_Sparkline_SampleWorks" )
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc03_pvSparkline_SampleWorks" )
  public void tc04_dataBar_SampleWorks() {
     ...
     */
    //Check sample title
    String sampleTitle = this.elemHelper.WaitForTextPresence( driver, By.id( "DataBarTitle" ), "dataBar", 20 );
    ...
    String expectedText = "defaults: { widthRatio:1, height: 10, startColor: \"#55A4D6\", endColor: \"#448FC8\", stroke: null, max: undefined, min: undefined, absValue: true, includeValue: false, valueFormat: function(v, format, st) { return \"\" + require(\"cdf/dashboard/Sprintf\")(format || \"%.1f\", v); } }";
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc04_dataBar_SampleWorks" )
  public void tc05_trendArrow_SampleWorks() {
    ...
    String expectedText = "defaults: { includeValue: false, good: true, valueFormat: function(v, format, st) { return require(\"cdf/dashboard/Sprintf\")(format || \"%.1f\", v); } }";
    assertEquals( defaultText, expectedText );
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc05_trendArrow_SampleWorks" )
  public void tc06_hyperlink_SampleWorks() {
    ...
    //Check Rows
    String row1 = this.elemHelper.WaitForTextPresence( driver, By.xpath( "//table[@id='HyperlinkObjTable']/tbody/tr/td" ), "Row 1", 20 );
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc06_hyperlink_SampleWorks" )
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc07_Circle_SampleWorks" )
  public void tc08_FormattedText_SampleWorks() {
    ...
    String expectedText = "defaults: { textFormat: function(v, st) { return st.colFormat ? require(\"cdf/dashboard/Sprintf\")(st.colFormat, v) : v; } }";
    assertEquals( defaultText, expectedText );
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc08_FormattedText_SampleWorks" )
   ...
   *    2. Order the table
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cde.samples.require.reference.others.tc09_CCCBulletChart_SampleWorks" )
