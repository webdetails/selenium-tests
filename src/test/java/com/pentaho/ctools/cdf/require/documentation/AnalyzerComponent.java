...
public class AnalyzerComponent extends BaseTest {
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    // The URL for the AnalyzerComponenet under CDF samples
    // This sample is in: Public/plugin-samples/CDF/Require Samples/Documentation/Component Reference/Core Components/AnalyzerComponenet
    this.elemHelper.Get( driver, PageUrl.ANALYZER_COMPONENT_REQUIRE );
