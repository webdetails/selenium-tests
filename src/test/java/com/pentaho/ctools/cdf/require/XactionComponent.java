...
public class XactionComponent extends BaseTest {
  ...
  public void tc0_PageContent_DisplayTitle() {
    ...
    // This samples is in: Public/plugin-samples/CDF/Require Samples/Documentation/Component Reference/Core Components/XactionComponent
    this.elemHelper.Get( driver, PageUrl.XACTION_COMPONENT_REQUIRE );
