...
public class OpenFlashChartComponent extends BaseTest {
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    this.driver.get( this.baseUrl + "api/repos/%3Apublic%3Aplugin-samples%3Apentaho-cdf%3Apentaho-cdf-require%3A30-documentation%3A30-component_reference%3A10-core%3A26-OpenFlashChartComponent%3Aopenflashchart_component.xcdf/generatedContent" );
  ...
  public void tc1_PageContent_DisplayTitle() {
    ...
    assertEquals( "OpenFlashChartComponent", this.elemHelper.WaitForElementPresentGetText( this.driver, By.xpath( "//div[@id='dashboardContent']/div/div/div/h2/span[2]" ) ) );
  }
  ...
  public void tc3_OpenFlashChart_ChartDisplayed() {
     ...
     * ## Step 1
     */
    assertNotNull( this.elemHelper.FindElement( this.driver, By.cssSelector( "object" ) ) );
    this.elemHelper.WaitForElementPresenceAndVisible( this.driver, By.cssSelector( "embed" ) );
    String attrWidth = this.elemHelper.GetAttribute( this.driver, By.cssSelector( "embed" ), "width" );
    String attrHeight = this.elemHelper.GetAttribute( this.driver, By.cssSelector( "embed" ), "height" );
    String attrType = this.elemHelper.GetAttribute( this.driver, By.cssSelector( "embed" ), "type" );
    String attrSrc = this.elemHelper.GetAttribute( this.driver, By.cssSelector( "embed" ), "src" );
