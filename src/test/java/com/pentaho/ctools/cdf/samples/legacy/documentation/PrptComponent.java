...
public class PrptComponent extends BaseTest {
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    this.elemHelper.Get( BaseTest.driver, PageUrl.PRPT_COMPONENT );
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc0_OpenSamplePage_Display" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc1_PageContent_DisplayTitle" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc2_ReloadSample_SampleReadyToUse" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc3_CheckDisplayPage_DataIsDisplayedAsExpected" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc4_TogglePromptPanel_PromptPanelEnableDisable" )
  public void tc5_SelectSeveralProducts_ReportIsRefreshed() {
    this.log.info( "tc5_SelectSeveralProducts_ReportIsRefreshed" );
    this.elemHelper.SwitchToDefault( BaseTest.driver );
    this.elemHelper.WaitForElementPresenceAndVisible( BaseTest.driver, By.cssSelector( "div#sampleObject iframe" ) );
    this.elemHelper.SwitchToFrame( BaseTest.driver, "sampleObject_prptFrame" );
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.PrptComponent.tc5_SelectSeveralProducts_ReportIsRefreshed" )
  public void tc6_SelectAllOutputTypeOptions_DialogBoxIsRaised() {
    ...
    this.elemHelper.WaitForElementInvisibility( BaseTest.driver, By.id( "glasspane" ) );
    //Check the generated image
    this.elemHelper.WaitForElementPresenceAndVisible( BaseTest.driver, By.cssSelector( "iframe#reportContent" ) );
    this.elemHelper.SwitchToFrame( BaseTest.driver, "reportContent" );
