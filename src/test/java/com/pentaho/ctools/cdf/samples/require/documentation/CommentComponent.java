...
public class CommentComponent extends BaseTest {
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.samples.require.documentation.CommentComponent.tc0_OpenSamplePage_Display" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.samples.require.documentation.CommentComponent.tc1_PageContent_DisplayTitle" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.samples.require.documentation.CommentComponent.tc2_ReloadSample_SampleReadyToUse" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.samples.require.documentation.CommentComponent.tc3_DisplayComponent_CheckDisplayedPage" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.samples.require.documentation.CommentComponent.tc4_AddComponent_CommentIsDisplayed" )
