...
public class ExecutePrptComponent extends BaseTest {
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    this.elemHelper.Get( BaseTest.driver, PageUrl.EXECUTE_PRPT_COMPONENT );
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc0_OpenSamplePage_Display" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc1_PageContent_DisplayTitle" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc2_ReloadSample_SampleReadyToUse" )
  public void tc3_CheckDisplayPage_DataIsDisplayedAsExpected() {
    ...
    this.elemHelper.FindElement( BaseTest.driver, By.xpath( "//button/span" ) ).click();
    this.elemHelper.WaitForElementPresenceAndVisible( BaseTest.driver, By.id( "fancybox-content" ) );
    //Move to iframe
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc3_CheckDisplayPage_DataIsDisplayedAsExpected" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc4_TogglePromptPanel_PromptPanelEnableDisable" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc5_SelectSeveralProducts_ReportIsRefreshed" )
   ...
   */
  @Test(
      dependsOnMethods = "com.pentaho.ctools.cdf.samples.legacy.documentation.ExecutePrptComponent.tc6_SelectAllOutputTypeOptions_DialogBoxIsRaised" )
