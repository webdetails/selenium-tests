...
public class CommentComponent extends BaseTest {
  // Indicate if pass over the test case remove comment
  private Boolean tcRemoveComment = false;
  ...
  public void tc0_OpenSamplePage_Display() {
    ...
    this.elemHelper.Get( driver, PageUrl.COMMENT_COMPONENT );
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.documentation.CommentComponent.tc0_OpenSamplePage_Display" )
  public void tc1_PageContent_DisplayTitle() {
    ...
    // Wait for visibility of 'CommentsComponent'
    String expectedSampleTitle = "CommentsComponent";
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.documentation.CommentComponent.tc1_PageContent_DisplayTitle" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.documentation.CommentComponent.tc2_ReloadSample_SampleReadyToUse" )
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.documentation.CommentComponent.tc3_DisplayComponent_CheckDisplayedPage" )
  public void tc4_AddComponent_CommentIsDisplayed() {
    ...
    String longTextExpected = "The policy states that a pre departure beverage should be served to First Class/Envoy Class customers on every flight. Beverages given by flight attendants (including bottles of water) must be collected before or during the walk through before takeoff/landing. Because we have not integrated ALL P/P\\'s between East/West, you may find that the West f/a\\'s collect before closing the a/c door as it was/may still be policy. Reasons short of laziness to not serve? Catering hasn\\'t provided adequate supplies yet. Steady stream of passengers because the flight is way late and the agents have a steady flow of customers line up. Even then, they should try. Short of that, there is NO excuse.";
    ...
    assertEquals( commentAdded2, longTextExpected );
    //Comment added 1
   ...
   */
  @Test( dependsOnMethods = "com.pentaho.ctools.cdf.documentation.CommentComponent.tc4_AddComponent_CommentIsDisplayed" )
