...
public class ReplacingSecurePrompt extends BaseTest {
	...
	//Log instance
	private static final Logger log = LogManager.getLogger( ReplacingSecurePrompt.class );
	...
	*/
	...
	public void tc0_openReplacingSecurePrompt() {
		log.info( "openReplacingSecurePrompt" );
		
		//Open CDE Tutorials Welcome page 
		elemHelper.Get(driver, PageUrl.CDF_TUTORIAL_REPLACING_SECURE_PROMPT);
		
		//Test if page was loaded
		assertEquals(elemHelper.WaitForElementPresentGetText(driver, By.xpath("//*[@id='title']/h1")),"Replacing Secure / Prompt");
