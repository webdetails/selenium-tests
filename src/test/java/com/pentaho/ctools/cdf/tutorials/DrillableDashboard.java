...
public class DrillableDashboard extends BaseTest {
	...
	//Log instance
	private static final Logger log = LogManager.getLogger( DrillableDashboard.class );
	...
	*/
	...
	public void tc0_openDrillableDashboards() {
		log.info( "openDrillableDashboards" );
		
		//Open CDE Tutorials Welcome page 
		elemHelper.Get(driver, PageUrl.CDF_TUTORIAL_DRILLABLE_DASHBOARD);
		
		//Test if page was loaded
		assertEquals(elemHelper.WaitForElementPresentGetText(driver, By.xpath("//*[@id='title']/h1")), "Drillable Dashboard");
