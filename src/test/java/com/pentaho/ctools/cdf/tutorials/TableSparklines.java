...
public class TableSparklines extends BaseTest {
	...
	//Log instance
	private static final Logger log = LogManager.getLogger( TableSparklines.class );
	...
	*/
	...
	public void tc0_openTableSparklines() {
		log.info( "openTableSparklines" );
		
		//Open CDE Tutorials Welcome page 
		elemHelper.Get(driver, PageUrl.CDF_TUTORIAL_TABLE_SPARKLINES);
		
		//Test if page was loaded
		assertEquals(elemHelper.WaitForElementPresentGetText(driver, By.xpath("//*[@id='title']/h1")),"Table with Sparklines");
