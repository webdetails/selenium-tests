...
public class GeoDashboard extends BaseTest {
	...
	//Log instance
	private static final Logger log = LogManager.getLogger( GeoDashboard.class );
	...
	*/
	...
	public void tc0_openGeoDashboard() {
		log.info( "openGeoDashboard" );
		
		//Open CDE Tutorials Welcome page 
		elemHelper.Get(driver, PageUrl.CDF_TUTORIAL_GEO_DASHBOARD);
		
		//Test if page was loaded
		assertEquals(elemHelper.WaitForElementPresentGetText(driver, By.xpath("//*[@id='title']/h1")),"Geo Dashboard");
