...
public class CDF435 extends BaseTest {
	...
	public void tc01_PrptComponent_RenderedResponsive() {
		...
		this.elemHelper.Get( baseUrl + "api/repos/%3Apublic%3AIssues%3ACDF%3ACDF-435%3AIssue_435.wcdf/generatedContent" );
		...
		frame = this.elemHelper.SwitchToFrame( driver, elementFrame );
