...
public class CDE417 extends BaseTest {
  ...
  public void tc01_PopupExportComponent_PreviewerRendersChart() {
    ...
    WebDriver frame = this.elemHelper.SwitchToFrame( driver, "browser.perspective" );
    ...
    this.elemHelper.Get( driver, PageUrl.ISSUES_CDF_548_EDIT );
     ...
     * ## Step 6 
     */
    this.elemHelper.Get( driver, PageUrl.ISSUES_CDF_548 );
