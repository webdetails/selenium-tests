...
public class CDE452 extends BaseTest {
  ...
  public void tc1_CdeDashboard_AccessDeniedEdit() {
    ...
    this.elemHelper.Get( baseUrl + "plugin/pentaho-cdf-dd/api/renderer/edit?absolute=false&inferScheme=false&file=i18nTest.wcdf&path=%2FCDE404%2Fdashboards%2F&solution=system&mode=edit" );
    ...
    this.elemHelper.Get( baseUrl + "api/repos/%3Apublic%3AIssues%3ACDF%3ACDF-430%3ACDE%3Ai18nTest.wcdf/edit" );
    this.elemHelper.WaitForElementInvisibility( driver, By.cssSelector( "div.blockUI.blockOverlay" ) );
     ...
     */
    //Log out
    this.elemHelper.Get( PageUrl.PUC );
