...
public class GeoDashboard extends BaseTest {
  // Access to wrapper for webdriver
  private final ElementHelper elemHelper = new ElementHelper();
  // Log instance
  private final Logger log = LogManager.getLogger( GeoDashboard.class );
  ...
  public void tc0_openGeoDashboard() {
    this.log.info( "openGeoDashboard" );

    //Open CDE Tutorials Welcome page 
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_GEO_DASHBOARD );

    //Test if page was loaded
    assertEquals( this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//*[@id='title']/h1" ) ), "Geo Dashboard" );
  ...
  public void tc3_checkTooltips() {
    this.cdftutorials.checkTooltips( 5 );
  }
}
