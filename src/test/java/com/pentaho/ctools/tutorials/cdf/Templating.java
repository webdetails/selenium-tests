...
public class Templating extends BaseTest {
  ...
  //Log instance
  private final Logger log = LogManager.getLogger( Templating.class );
  ...
  */
  ...
  public void tc0_openTemplating() {
    this.log.info( "openTemplating" );

    //Open CDE Tutorials Welcome page 
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_TEMPLATING );

    //Test if page was loaded
    assertEquals( this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//*[@id='title']/h1" ) ), "Templating" );
