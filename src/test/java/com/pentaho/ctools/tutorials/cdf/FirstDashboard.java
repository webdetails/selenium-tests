...
public class FirstDashboard extends BaseTest {
  ...
  // Log instance
  private final Logger log = LogManager.getLogger( FirstDashboard.class );
  ...
  */
  ...
  public void tc0_openFirstDashboard() {
    this.log.info( "openFirstDashboard" );

    //Open CDE Tutorials Welcome page 
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_FIRST_DASHBOARD );

    //Test if page was loaded
    assertEquals( this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//*[@id='title']/h1" ) ), "First Dashboard" );
