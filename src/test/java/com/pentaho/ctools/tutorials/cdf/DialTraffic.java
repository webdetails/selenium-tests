...
public class DialTraffic extends BaseTest {
  ...
  */
  ...
  public void tc0_openDialTraffic() {
    this.log.info( "openDialTraffic" );

    // Open CDE Tutorials Welcome page
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_DIAL_TRAFFIC );

    // Test if page was loaded
    assertEquals( this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//*[@id='title']/h1" ) ), "Dial + Traffic" );
  ...
  public void tc3_checkTooltips() {
    this.cdftutorials.checkTooltips( 2 );
  }
}
