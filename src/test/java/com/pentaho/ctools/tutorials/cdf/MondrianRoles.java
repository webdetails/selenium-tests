...
public class MondrianRoles extends BaseTest {
  ...
  //Log instance
  private final Logger log = LogManager.getLogger( MondrianRoles.class );
  ...
  public void tc0_openMondrianRoles() {
    this.log.info( "openMondrianRoles" );

    //Open CDE Tutorials Welcome page 
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_MONDRIAN_ROLES );
