...
public class TableSparklines extends BaseTest {
  // Access to wrapper for webdriver
  private final ElementHelper elemHelper = new ElementHelper();
  // Log instance
  private final Logger log = LogManager.getLogger( TableSparklines.class );
  ...
  *
  * Description:
  *   Opens Table with Sparklines tutorial and check if the page was loaded.
  */
  @Test
  public void tc0_openTableSparklines() {
    this.log.info( "tc0_openTableSparklines" );

    //Open CDE Tutorials Welcome page 
    this.elemHelper.Get( driver, PageUrl.CDF_TUTORIAL_TABLE_SPARKLINES );

    //Test if page was loaded
    assertEquals( this.elemHelper.WaitForElementPresentGetText( driver, By.xpath( "//*[@id='title']/h1" ) ), "Table with Sparklines" );
  }
