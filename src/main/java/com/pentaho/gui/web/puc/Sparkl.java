...
public class Sparkl {
  ...
  private final Logger log = LogManager.getLogger( Sparkl.class );
  ...
  public void OpenSparkl() {
    ...
    this.elemHelper.Get( driver, PageUrl.SPARKL );
  ...
  public boolean CheckSortBy( String by ) {
    ...
    List<WebElement> listElements = this.elemHelper.FindElements( driver, By.cssSelector( "div.sparklPluginCardContainer" ) );
  ...
  public boolean AssertElementsFiltered( String type ) {
    ...
    List<WebElement> listElements = this.elemHelper.FindElements( driver, By.xpath( "//table[@id='elementsTableObjTable']/tbody/tr" ) );
