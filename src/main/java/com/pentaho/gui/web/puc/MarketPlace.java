...
public class MarketPlace {
  ...
  private final Logger log = LogManager.getLogger( MarketPlace.class );
  ...
  public void GoToMarketPlace() {
    ...
    this.elemHelper.SwitchToFrame( driver, "marketplace.perspective.osgi" );
  ...
  public void CheckInstalledTab() {
    ...
    List<WebElement> allPlugins = this.elemHelper.FindElements( driver, By.xpath( "//div[@class='filteredPluginsContainer ng-isolate-scope']/div/ul/li" ) );
    ...
    assertEquals( "Installed", text );
    element.click();
    allPlugins = this.elemHelper.FindElements( driver, By.xpath( "//div[@class='filteredPluginsContainer ng-isolate-scope']/div/ul/li" ) );
  ...
  public void CheckPluginPopup( int pos ) {
    ...
    if ( element != null ) {
      List<WebElement> listElements = this.elemHelper.FindElements( driver, By.xpath( "//div[@class='carousel-inner']/div" ) );
   ...
   * be called from the Marketplace page with the driver set to marketplace.perspective.
   *
   * @return size
   */
